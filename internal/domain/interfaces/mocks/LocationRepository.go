...
import (
	...
	models "github.com/imperatorofdwelling/Full-backend/internal/domain/models"
)
...
func (_m *LocationRepository) FindByNameMatch(ctx context.Context, match string) (*[]models.Location, error) {
