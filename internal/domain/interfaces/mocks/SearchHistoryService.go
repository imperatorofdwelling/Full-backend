...
type mockConstructorTestingTNewSearchHistoryService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewSearchHistoryService(t mockConstructorTestingTNewSearchHistoryService) *SearchHistoryService {
