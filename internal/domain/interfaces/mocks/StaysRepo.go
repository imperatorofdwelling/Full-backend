...
// GetStatistics provides a mock function with given fields: ctx, userID
func (_m *StaysRepo) GetStatistics(ctx context.Context, userID string) (*stays.Statistics, error) {
	...
	var r0 *stays.Statistics
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*stays.Statistics, error)); ok {
		return rf(ctx, userID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *stays.Statistics); ok {
		r0 = rf(ctx, userID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*stays.Statistics)
		}
	}
