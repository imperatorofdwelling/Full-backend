...
type mockConstructorTestingTNewStaysReviewsService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewStaysReviewsService(t mockConstructorTestingTNewStaysReviewsService) *StaysReviewsService {
