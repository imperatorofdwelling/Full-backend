...
type mockConstructorTestingTNewUsersReportsService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewUsersReportsService(t mockConstructorTestingTNewUsersReportsService) *UsersReportsService {
