...
func (s *Service) UpdateStaysReview(ctx context.Context, stayReview *staysreviews.StaysReviewEntity, id uuid.UUID) (*staysreviews.StaysReview, error) {
	...
	model, err := s.Repo.FindOneStaysReviewByID(ctx, id)
	if err != nil {
		return nil, err
	}
